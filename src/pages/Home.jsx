...
export default function Home() {
  ...
  return (
    <div className="min-h-screen pt-20 transition-colors duration-300" style={{ backgroundColor: 'var(--bg-dark)' }}>
      {/* Hero Section */}
      <div className="relative py-20 px-4 overflow-hidden" style={{ background: 'linear-gradient(to bottom right, var(--bg-dark), var(--bg-dark), var(--bg-card))' }}>
        <div className="absolute inset-0 bg-hero-glow opacity-30"></div>
        
        {/* Floating 3D Elements */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-20 left-10 animate-float">
            <div className="w-32 h-32 bg-gradient-to-br from-brand-orange/20 to-purple-500/20 rounded-3xl backdrop-blur-sm border border-white/10 transform rotate-12 shadow-2xl"></div>
          </div>
          <div className="absolute top-40 right-20 animate-float-delayed">
            <div className="w-24 h-24 bg-gradient-to-br from-blue-500/20 to-brand-orange/20 rounded-2xl backdrop-blur-sm border border-white/10 transform -rotate-12 shadow-2xl"></div>
          </div>
          <div className="absolute bottom-32 left-1/4 animate-float">
            <div className="w-20 h-20 bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-xl backdrop-blur-sm border border-white/10 transform rotate-45 shadow-2xl"></div>
          </div>
          <div className="absolute top-1/2 right-10 animate-float-delayed">
            <div className="w-28 h-28 bg-gradient-to-br from-green-500/20 to-blue-500/20 rounded-3xl backdrop-blur-sm border border-white/10 transform -rotate-6 shadow-2xl"></div>
          </div>
        </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="text-center md:text-left">
                <div className="inline-block mb-4 px-4 py-2 bg-brand-orange/10 border border-brand-orange/30 rounded-full">
                ...
                <h1 className="text-5xl md:text-6xl font-bold mb-6" style={{ color: 'var(--text-primary)' }}>
                  Micro-Job: The Verified Student Marketplace
                </h1>
                <p className="text-xl mb-8" style={{ color: 'var(--text-muted)' }}>
                  Connect verified university students with clients who need their skills. Secure escrow payments ensure trust for everyone.
                </p>
                <div className="flex justify-center md:justify-start gap-4 flex-wrap">
                  {isLoggedIn ? (
                    <Link to="/dashboard" className="bg-brand-orange hover:bg-orange-600 text-white px-8 py-3 rounded-lg font-semibold transition transform hover:scale-105 shadow-lg hover:shadow-brand-orange/50">
                      Go to Dashboard
                    </Link>
                  ) : (
                    <Link to="/auth" className="bg-brand-orange hover:bg-orange-600 text-white px-8 py-3 rounded-lg font-semibold transition transform hover:scale-105 shadow-lg hover:shadow-brand-orange/50">
                      Get Started
                    </Link>
                  )}
                  <a href="#how-it-works" className="border-2 border-brand-orange text-brand-orange hover:bg-brand-orange/10 px-8 py-3 rounded-lg font-semibold transition transform hover:scale-105">
                    Learn More
                  </a>
                </div>
              </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="bg-gradient-to-br from-blue-500/20 to-cyan-500/20 rounded-2xl p-6 backdrop-blur-sm border border-white/10 flex items-center justify-center aspect-square animate-pulse">
                        <div className="text-center">
                          ...
                          <p className="text-cyan-400 font-bold text-sm">Verified Students</p>
                        </div>
                      </div>
                      <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-2xl p-6 backdrop-blur-sm border border-white/10 flex items-center justify-center aspect-square animate-pulse" style={{ animationDelay: '0.2s' }}>
                        <div className="text-center">
                          ...
                          <p className="text-pink-400 font-bold text-sm">Secure Escrow</p>
                        </div>
                      </div>
                      <div className="bg-gradient-to-br from-green-500/20 to-emerald-500/20 rounded-2xl p-6 backdrop-blur-sm border border-white/10 flex items-center justify-center aspect-square animate-pulse" style={{ animationDelay: '0.4s' }}>
                        <div className="text-center">
                          ...
                          <p className="text-emerald-400 font-bold text-sm">Real-time Chat</p>
                        </div>
                      </div>
                      <div className="bg-gradient-to-br from-orange-500/20 to-red-500/20 rounded-2xl p-6 backdrop-blur-sm border border-white/10 flex items-center justify-center aspect-square animate-pulse" style={{ animationDelay: '0.6s' }}>
                        <div className="text-center">
                          ...
                          <p className="text-orange-400 font-bold text-sm">Instant Pay</p>
                        </div>
                      </div>
                    </div>
                  </div>
