      ...
      <div className="max-w-7xl mx-auto">
        ...
        {isVerified && activeView === 'seller' && (
          <div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <Link to="/student/profile" className="rounded-xl p-8 border hover:border-brand-orange transition group" style={{ backgroundColor: 'var(--bg-card)', borderColor: 'var(--border-color)' }}>
                <div className="w-12 h-12 bg-brand-orange/20 rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition">
              ...
              <Link to="/student/gigs" className="rounded-xl p-8 border hover:border-brand-orange transition group" style={{ backgroundColor: 'var(--bg-card)', borderColor: 'var(--border-color)' }}>
                <div className="w-12 h-12 bg-brand-orange/20 rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition">
              ...
              <Link to="/student/orders" className="rounded-xl p-8 border hover:border-brand-orange transition group" style={{ backgroundColor: 'var(--bg-card)', borderColor: 'var(--border-color)' }}>
                <div className="w-12 h-12 bg-brand-orange/20 rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition">
        ...
        {activeView === 'buyer' && (
          <div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <Link to="/client/search" className="rounded-xl p-8 border hover:border-brand-orange transition group" style={{ backgroundColor: 'var(--bg-card)', borderColor: 'var(--border-color)' }}>
                <div className="w-12 h-12 bg-brand-orange/20 rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition">
                  <Users className="w-6 h-6 text-brand-orange" />
                </div>
              ...
              <Link to="/client/orders" className="rounded-xl p-8 border hover:border-brand-orange transition group" style={{ backgroundColor: 'var(--bg-card)', borderColor: 'var(--border-color)' }}>
                <div className="w-12 h-12 bg-brand-orange/20 rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition">
                  <Package className="w-6 h-6 text-brand-orange" />
                </div>
                <h3 className="text-xl font-bold mb-2" style={{ color: 'var(--text-primary)' }}>My Orders</h3>
              ...
              <Link to="/client/transactions" className="rounded-xl p-8 border hover:border-brand-orange transition group" style={{ backgroundColor: 'var(--bg-card)', borderColor: 'var(--border-color)' }}>
                <div className="w-12 h-12 bg-brand-orange/20 rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition">
